...
export default function ContactForm({bg_color}){
    return(
        <div className="-mt-10">
            ...
            <div className={`flex flex-col justify-center items-center p-20 pt-0 pt-3 bg-[#232533] w-full`}>
