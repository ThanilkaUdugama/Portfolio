...
export default function InfoSectionContentLeft({cards_data, bg_color, setIndex, index}){
    return(
        <div className={`mobile-s: h-[16rem] mobile-s: pt-[1rem] card-section bg-gradient-to-t from-[#323445] to-[#232533] section-content-left overflow-auto whitespace-nowrap justify-center pb-0 px-10`}>
