...
export default function IntroLeft(){
    ...
    return(
        <div className='mobile-s: bg-gradient-to-t from-[#232533] to-[#323445] bg-[#323445] w-full tablet:w-3/5 h-96 tablet:h-100 flex items-center justify-center relative'>
                <img className= {`duration-500 grayscale saturate-50 h-96 tablet:h-100 drop-shadow-2xl z-10 contrast-80`} src = {User}></img>
                ...
                <div className= {`duration-1000 absolute z-20 flex justify-center items-center`}>
                ...
                <div className= {`duration-1000 absolute bg-[#FEC158] mobile-s:h-64 mobile-s:w-64 mobile-m:w-72 mobile-m:h-72 mobile-l:h-80 mobile-l:w-80 laptop-m:h-96 laptop-m:w-96 translate-y-4 rounded-full`}>
                </div>
